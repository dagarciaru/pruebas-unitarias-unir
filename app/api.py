...
def multiply(op_1, op_2): #se define la función para la operación de multiplicación
    try:
        num_1, num_2 = util.convert_to_number(op_1), util.convert_to_number(op_2)
...
def divide(op_1, op_2): #se define la función para la operación de división
    try:
        num_1, num_2 = util.convert_to_number(op_1), util.convert_to_number(op_2)
        if num_2 == 0:
...
def power(op_1, op_2): #se define la función para la operación de potenciación
    try:
        num_1, num_2 = util.convert_to_number(op_1), util.convert_to_number(op_2)
...
def square_root(op_1): #se define la función para la operación de raiz cuadrada
    try:
